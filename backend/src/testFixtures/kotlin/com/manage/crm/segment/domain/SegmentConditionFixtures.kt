...
class SegmentConditionFixtures private constructor() {
    ...
    fun build(): SegmentCondition = SegmentCondition(
        id = id,
        segmentId = segmentId,
        fieldName = fieldName,
        operator = operator,
