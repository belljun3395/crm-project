            ...
            it("creates, reads, and lists webhooks") {
                ...
                val createResponse =
                    webTestClient
                        ...
                        .jsonPath("$.data.url")
                        .isEqualTo("https://example.com/webhook")
                        .jsonPath("$.data.events[0]")
                        .isEqualTo("USER_CREATED")
                        .jsonPath("$.data.events[1]")
                        .isEqualTo("EMAIL_SENT")
                        .returnResult()

                val createdId =
                    objectMapper
                        .readTree(createResponse.responseBody)
                        .get("data")
                        .get("id")
                        .asLong()
