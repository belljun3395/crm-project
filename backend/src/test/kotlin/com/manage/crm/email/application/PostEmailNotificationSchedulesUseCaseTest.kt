...
class PostEmailNotificationSchedulesUseCaseTest :
    BehaviorSpec({
        ...
        given("PostEmailNotificationSchedulesUseCase") {
            `when`("post email notification schedules") {
                ...
                coEvery { scheduleTaskService.newSchedule(any(NotificationEmailSendTimeOutEventInput::class)) } answers
                    { input.eventId.value }
            ...
            `when`("segmentId is provided for scheduled notification") {
                ...
                coEvery { scheduleTaskService.newSchedule(any(NotificationEmailSendTimeOutEventInput::class)) } answers
                    { firstArg<NotificationEmailSendTimeOutEventInput>().eventId.value }
