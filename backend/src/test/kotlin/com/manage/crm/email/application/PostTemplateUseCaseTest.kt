    ...
    BehaviorSpec({
        ...
        given("UC-EMAIL-001 PostTemplateUseCase") {
            ...
            `when`("modify existing template") {
                ...
                val modifiedEmailTemplate =
                    emailTemplateFixtures
                        .withVersion(
                            EmailTemplateVersionFixtures.giveMeOne().withValue(useCaseIn.version!!).build(),
                        ).build()
            ...
            `when`("create new template with mixed user and campaign variables") {
                val useCaseIn =
                    PostTemplateUseCaseIn(
                        ...
                        version = null,
                        body =
                            "<html><body><p>Hello <span th:text=\"\${user_name}\"></span></p>" +
                                "<p>Email: <span th:text=\"\${user_email}\"></span></p>" +
                                "<p>Event Count: <span th:text=\"\${campaign_eventCount}\"></span></p></body></html>",
