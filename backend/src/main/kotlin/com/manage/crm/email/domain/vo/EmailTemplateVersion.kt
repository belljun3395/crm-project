...
data class EmailTemplateVersion(
    ...
    companion object {
        ...
        fun isValidUpdateVersion(
            currentVersion: EmailTemplateVersion,
            newVersion: Float,
        ): Boolean = newVersion > currentVersion.value

        fun calcNewVersion(
            currentVersion: EmailTemplateVersion,
            plusAmount: Float = DEFAULT_VERSION_PLUS_AMOUNT,
        ): Float = currentVersion.value + plusAmount
    }
