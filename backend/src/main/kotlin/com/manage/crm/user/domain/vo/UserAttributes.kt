...
data class UserAttributes(
    ...
    fun getValue(
        key: RequiredUserAttributeKey,
        objectMapper: ObjectMapper,
    ): String = objectMapper.readValue(value, Map::class.java)[key.value] as String

    fun getValue(
        key: String,
        objectMapper: ObjectMapper,
    ): String = objectMapper.readValue(value, Map::class.java)[key].toString()
