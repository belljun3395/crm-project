...
class EventCustomRepositoryImpl(
    ...
    private fun matchesQueryChain(
        event: Event,
        queries: List<SearchByPropertyQuery>,
    ): Boolean {
    ...
    private fun matchesSingleQuery(
        event: Event,
        query: SearchByPropertyQuery,
    ): Boolean =
    ...
    private fun matchesSingleProperty(
        event: Event,
        operation: Operation,
