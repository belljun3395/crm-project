...
class CampaignDashboardStreamManager(
    ...
    fun streamEvents(
        ...
        return Flux
            .create<CampaignDashboardEvent> { sink ->
     ...
     */
    suspend fun trimStream(
        campaignId: Long,
        maxLength: Long = 10000,
    ) {
        try {
            val streamKey = getStreamKey(campaignId)
            reactiveRedisTemplate
